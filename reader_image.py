...
def get_batch_images(batch_size, image_width, image_height, data_path):
    ...
    while index < batch_size:
        ...
        image, label ,o= read_a_image_by_name(name, image_width, image_height, data_path)
        images.append(image)
        labels.append(label)
        os.append(o)
        index += 1
...
# def get_image_2_image(batch_size, image_width, image_height, data_path):
...
if __name__ == '__main__':
    i, l,c = get_batch_images(50,224,224,"./databet/X/0")
