...
from reader_image import get_train_batch,get_test_batch1,get_roc_batch,get_test_batch
            ...
            while not coord.should_stop():
                ...
                if step% 2000 == 0 and step>0:
                    ...
                    if float(fake_y_accuracy_1)>max_accuracy:
                        ...
                        f.close()
                        save_path = saver.save(sess, checkpoints_dir + "/bestmodel/model.ckpt", global_step=step)
                        print("Model saved in file: %s" % save_path)
