...
from reader_image import get_train_batch,get_test_batch1,get_test_batch2,get_batch_images
...
import numpy as np
from plot_til.plot import  plot_conv_output,draw_heatmap
import utils
...
tf.flags.DEFINE_string('load_model','20190611-1650/bestmodel',
